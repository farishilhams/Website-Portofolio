      ...
      <section id="about" className="w-full max-w-7xl mx-auto py-24 md:py-32 cursor-default bg-background overflow-hidden border-t border-text-secondary/10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16">
              <div className="flex flex-col">
                <Fade>
                  ...
                  <p className="text-base text-text-secondary leading-relaxed font-medium">Saya Web Developer dan Machine Learning Engineer yang berpengalaman dalam merancang dan mengembangkan aplikasi modern menggunakan React.js, Next.js, Node.js, Express.js, Laravel, dan Python. Saya terampil dalam membangun RESTful APIs, merancang arsitektur backend, serta mengembangkan model Machine Learning dan Deep Learning untuk menghasilkan solusi cerdas berbasis data.</p>
                </Fade>
              </div>
              ...
              <div className="flex flex-col">
                <Fade>
                  ...
                  <p className="text-base text-text-secondary leading-relaxed font-medium">Saya berkomitmen untuk menghadirkan solusi yang efisien, mudah dikelola, dan skalabel melalui praktik terbaik rekayasa perangkat lunak, menggabungkan performa web modern dengan kekuatan otomasi serta kecerdasan buatan.</p>
                </Fade>
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-6 gap-x-10">
                <FadeLeft delay={0.1}>
                  <div className="flex flex-col p-2 -m-2 rounded-xl transition-colors duration-300 hover:bg-thirdary/40">
                    ...
                    <span className="text-base font-semibold text-text-primary">Farish Ilham Syahrani</span>
                  </div>
                </FadeLeft>
                ...
                <FadeLeft delay={0.2}>
                  <div className="flex flex-col p-2 -m-2 rounded-xl transition-colors duration-300 hover:bg-thirdary/40">
                    ...
                    <span className="text-base font-semibold text-text-primary">Bangkalan, Jawa Timur, Indonesia</span>
                  </div>
                </FadeLeft>
                ...
                <FadeLeft delay={0.3}>
                  <div className="flex flex-col p-2 -m-2 rounded-xl transition-colors duration-300 hover:bg-thirdary/40">
                    ...
                    <span className="text-base font-semibold text-text-primary">+62 878-5056-6785</span>
                  </div>
                </FadeLeft>
                ...
                <FadeLeft delay={0.4}>
                  <div className="flex flex-col p-2 -m-2 rounded-xl transition-colors duration-300 hover:bg-thirdary/40">
                    ...
                    <span className="text-base font-semibold text-text-primary">3.70</span>
                  </div>
                </FadeLeft>
                ...
                <FadeLeft delay={0.5}>
                  <div className="flex flex-col p-2 -m-2 rounded-xl transition-colors duration-300 hover:bg-thirdary/40">
                    ...
                    <a href="mailto:farishilham.s@gmail.com" className="text-base font-semibold text-text-primary hover:text-text-secondary transition-colors underline decoration-text-secondary/30 underline-offset-4">
                ...
                <FadeLeft delay={0.6}>
                  <div className="flex flex-col p-2 -m-2 rounded-xl transition-colors duration-300 hover:bg-thirdary/40">
                    ...
                    <span className="text-base font-semibold text-text-primary">Universitas Trunodjoyo Madura</span>
                  </div>
                </FadeLeft>
              </div>
            </div>
        ...
        <Fade>
          <div className="mt-24 md:mt-32 pb-6 border-text-secondary/10">
            <ScrollVelocity texts={["Hello I'm Rishy", "Web Developer", "Machine Learning Engineer"]} velocity={velocity} className="font-black tracking-tighter text-thirdary dark:text-button-hover opacity-50" />
          </div>
        </Fade>
      </section>
    </>
